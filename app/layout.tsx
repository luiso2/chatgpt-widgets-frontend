...
export const metadata: Metadata = {
  title: "ChatGPT Dynamic Widgets",
  description: "Display dynamic widgets in ChatGPT using MCP",
};
...
// SDK Bootstrap component patches browser APIs for ChatGPT iframe
    ...
    <>
      ...
      <script dangerouslySetInnerHTML={{
        __html: `(function() {
          ...
          // Handle external links via openai.openExternal
          ...
          // Patch fetch for correct CORS handling in iframe
